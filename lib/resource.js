...
var Resource = function () {
  ...
  _createClass(Resource, [{
    ...
    key: 'addThunk',
    value: function addThunk(type, work) {
      var _methods2;
      ...
      (_methods2 = this.methods).set.apply(_methods2, _toConsumableArray(this.formatThunk([type, work])));
    }
    ...
    value: function formatThunk(_ref4) {
      ...
      return [this.localise(name), work];
    }
